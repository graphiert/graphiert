...
export const Card = React.memo(({
  ...
  <div
    ...
    className={cn(
      "rounded-lg relative bg-gray-100 dark:bg-neutral-900 overflow-hidden min-h-56 lg:min-h-[10.5rem] w-full transition-all duration-300 ease-out my-2 lg:mx-2",
